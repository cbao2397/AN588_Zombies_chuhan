--- 
title: "yangy22_PeerCommentary_chuhan_03"
author: "Emily Yang"
date: "2023-10-10"
...
EY: I can't knit with your picture because it is stored on your desktop.<br>
...
<br> EY: I really liked how many fewer lines you needed with ColMeans I will definitly use that next time. I think the instructions say not to use sd because they are for samples and not populations. But our answers came out to be very similar. <br>
...
Problem 2 complete :)
<br> EY: We did the same thing. I like your arrangement very space saving. <br>
...
<br> EY: The problem asks for ggplot but honestly it looks fine to me. <br>
...
<br> EY: We did this the same way. I like how you made them all different chunks. Do you have any guesses on what type of distribution those last two are from? <br> 
...
<br> EY: I'm not sure if the same CI calculations can be used for the last two variables but I did the rest the same way you did. <br> 
...
Problem 6 complete :)
<br> EY: We did almost the same thing. You got 100 samples of size 30 and found the mean of everything vs I took the means of each sample and then found the mean of that. I think the only thing missing is answering the last two questions about if they are now normally distributed.<br>
