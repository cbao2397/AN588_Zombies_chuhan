...
**Note: **Among these variables, height, weight, and age are normally distributed, while the other two variables are not. I guess the last two are from Poisson distribution. 
